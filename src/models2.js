...
const modelMappings = [
    ...
    { tags: ['recycling_type=container'], model: 'w_recycling_type_container.glb', geometryType: 'point', config: { scale: 4.0, heightOffset: 0.0, rotation: [30, 40, 50] } },  // Bicycle parking model for amenity=bicycle_parking 
...
{ tags: ['leisure=garden'], model: '', geometryType: 'area', config: { scale: 1.0, heightOffset: 0.0, rotation: [0, 0, 0] } }, // Garden area models
  ...
  { tags: ['highway=footway'], model: 'w_highway_footway.glb', geometryType: 'line', config: { scale: 1.0, heightOffset: 0.0, rotation: [0, 0, 0] } }, // Footway line models
   ...
   { tags: ['highway=cycleway'], model: 'w_highway_residential.glb', geometryType: 'line', config: { scale: 4.0, heightOffset: 0.0, rotation: [30, 40, 50] } }, // Footway area texture    
      { tags: ['highway=residential'], model: 'w_highway_residential.glb', geometryType: 'line', config: { scale: 8.0, heightOffset: 0.0, rotation: [0, 0, 0] } }, // Residential road line models
